		...
		if(
			...
			<div class="notice notice-error">
				<p>
					<?php
					printf(
						__( 'You\'re currently running the free version of %1$s, but you have a premium order number entered. %2$sDownload%3$s the premium version and %4$sread instructions%5$s on how to upgrade. %6$sDismiss%7$s this notice.', 'vantage' ),
						$theme->get( 'Name' ),
